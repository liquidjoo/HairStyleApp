 ...
 * @since 2011.05.04
 */
public class FreeBoard extends Fragment implements OnClickListener
{
	View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.board_custom_list_view_example_activity, container, false);
		
		Button bSetListView = (Button)view.findViewById(R.id.writeBtn);
		Button bRefresh = (Button)view.findViewById(R.id.custom_list_view_example_activity_b_refresh);
	...
	public class GetContacts extends AsyncTask<Void, Void, Void> {
	    ...
	    protected void onPostExecute(Void result) {
	       ...
	       listview = (ListView)view.findViewById(R.id.custom_list_view_example_activity_lv_list);
	       if (pDialog.isShowing())
	          pDialog.dismiss();

	       its = new ArrayList<BoardInfo>();
	       
	       CustomAdapter Boarditadapt = new CustomAdapter(getActivity(), R.layout.board_list_view_row, contactList);
	       Log.e("----------------", "--------------------------------");
	...
	public void onClick(View v)
	{
		...
		case R.id.custom_list_view_example_activity_b_refresh:
			new GetContacts().execute();
			Toast.makeText(getActivity(), "���ΰ�ħ ����", Toast.LENGTH_SHORT).show();
			break;
	...
	private void write() {
		Intent in = new Intent(getActivity().getApplicationContext(), Write.class);
	...
	private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(getActivity().getApplicationContext(), ViewBoard.class);
